...
public class PriorityQueueExample {
    public static void main(String[] args) {
        ...
        int removedHighestPriority2 = priorityQueue.poll();
        System.out.println("Наивысший приоритет (после удаления): " + removedHighestPriority2);
        System.out.println("Приоритетная очередь после извлечения: " + priorityQueue);

        int removedHighestPriority3 = priorityQueue.poll();
        System.out.println("Наивысший приоритет (после удаления): " + removedHighestPriority3);
        System.out.println("Приоритетная очередь после извлечения: " + priorityQueue);
    }
}
